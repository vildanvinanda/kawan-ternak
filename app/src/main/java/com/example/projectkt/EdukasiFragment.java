...
public class EdukasiFragment extends Fragment {
    ...
    private CardView kambing,sapi,domba;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        kambing = view.findViewById(R.id.kambing);
        sapi = view.findViewById(R.id.sapi);
        domba = view.findViewById(R.id.domba);

        kambing.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(getActivity(), DaftarEdukasiActivity.class);
        ...
        domba.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(getActivity(), DaftarEdukasiDomba.class);
                startActivity(intent);
            }
        });
        sapi.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(getActivity(), DaftarHewanSapi.class);
                startActivity(intent);
            }
        });
